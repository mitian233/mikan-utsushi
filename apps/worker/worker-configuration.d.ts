/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d8b1e2592d4b7064366c81d23741fb83)
// Runtime types generated with workerd@1.20260911.1 2026-08-22
interface __BaseEnv_Env {
	QQ_API_BASE: "https://api.sgroup.qq.com";
	QQ_TOKEN_URL: "https://bots.qq.com/app/getAppAccessToken";
	GROUP_CHAT_AGENT: DurableObjectNamespace<import("./src/index").GroupChatAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "GroupChatAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "QQ_API_BASE" | "QQ_TOKEN_URL">> {}
}
declare module "*.md" {
	const value: string;
